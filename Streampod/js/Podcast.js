(function(window, undefined) {
    ...
    var AudioPlayer = (function() {
        ...
        function listHandler(evt) {
            ...
            if (
                evt.target.matches(".pl-list__title") ||
                evt.target.matches(".pl-list__track") ||
                evt.target.matches(".pl-list__icon") ||
                evt.target.matches(".pl-list__eq") ||
                evt.target.matches(".eq")
            ) {
...
AP.init({
    playList: [{
            icon: iconImage,
            title: "The Epidemic of Unemployment",
            file: "https://drive.google.com/uc?export=download&id=1XvjIVheUdE-ksgPEr1iKwQNPwQ7ScWge"
        },
        {
            icon: iconImage,
